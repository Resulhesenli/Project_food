...
function cards() {
  // использыем классы для карточек
...
function timer(id, deadline) {
  ...
  function getTimeRemaining(endtime) {
    ...
    if (t <= 0) {
      ...
      days = Math.floor(t / (1000 * 60 * 60 * 24)), seconds = Math.floor(t / 1000 % 60), hours = Math.floor(t / (1000 * 60 * 60) % 24), minutes = Math.floor(t / 1000 / 60 % 60);
    }
    return {
      'total': t,
      'days': days,
